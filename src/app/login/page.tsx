      ...
      <div className="max-w-md w-full space-y-12">
        <div className="text-center space-y-4">
          ...
          <div className="space-y-1.5">
            <h1 className="text-5xl font-black text-slate-900 tracking-tight leading-none">{BRAND.name}</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2.5">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    required 
                    className="flex h-14 w-full pl-12 rounded-2xl border border-slate-100 bg-slate-50/50 focus:bg-white focus:ring-4 focus:ring-primary/5 focus:border-primary/30 focus:outline-none"
                  />
                </div>
              </div>
              <div className="space-y-2.5">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    required 
                    className="flex h-14 w-full pl-12 pr-12 rounded-2xl border border-slate-100 bg-slate-50/50 focus:bg-white focus:ring-4 focus:ring-primary/5 focus:border-primary/30 focus:outline-none"
                  />
                  <button
                    type="button"
              ...
              <div className="space-y-5 pt-4">
                <Button 
                  ...
                  className="w-full h-15 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground font-black text-lg shadow-xl shadow-primary/20 transition-all active:scale-[0.98]"
                >
        ...
        <AlertDialogContent className="rounded-[2.5rem] border-none shadow-2xl p-8">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-slate-600 font-medium text-lg leading-relaxed">
              Jaringan {BRAND.name} saat ini beroperasi dalam basis undangan beta privat. Kami belum menerima permintaan pendaftaran publik baru saat ini.
            </AlertDialogDescription>
          </AlertDialogHeader>
