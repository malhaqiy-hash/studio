...
export function ShareSheet({ isOpen, onOpenChange, postUrl }: ShareSheetProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md p-0 border-none bg-[#1c1f24] text-white rounded-t-[2.5rem] sm:rounded-[3rem] overflow-hidden outline-none shadow-2xl flex flex-col transition-all max-h-[95vh]">
        {/* Header */}
        <div className="p-6 pb-4">
          <h3 className="text-xl font-black text-white/90">Bagikan Konten</h3>
        </div>
          ...
          <div className="px-6 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[9px] font-bold text-accent px-2 py-0.5 bg-accent/10 rounded-full">Sinergi Aktif</span>
              </div>
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <span className="text-[9px] text-gray-500 font-bold uppercase tracking-tight">
                            {friend.status === 'online' ? 'Aktif' : 'Ru Saja'}
                          </span>
                        </div>
                      </button>
                    );
            ...
            {/* External Apps Section - No longer mt-auto, tight with friends list */}
            <div className="bg-[#121418] -mx-6 p-8 py-6 rounded-t-[3rem] border-t border-white/5 mt-4">
              <div className="flex items-center gap-3 mb-6">
                <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Berbagi ke Aplikasi Luar</span>
                <div className="h-px flex-1 bg-white/5" />
              </div>
              
              <div className="grid grid-cols-4 gap-y-8 gap-x-4 pb-8">
