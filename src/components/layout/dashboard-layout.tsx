    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground font-body relative overflow-x-hidden">
      ...
      <header className="sticky top-0 z-[100] w-full border-b bg-background/80 backdrop-blur-md px-4 h-11 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="font-aesthetic text-xl text-primary/80 lowercase italic select-none ml-1 leading-none">{activeAccount?.type}</span>
        </div>
                  ...
                  >
                    ...
                    <SheetHeader className="p-4 pt-1 pb-3 bg-primary/5 border-b border-border/50">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-aesthetic text-xl text-primary italic lowercase select-none leading-none">{activeAccount?.type}</span>
                      </div>
                    </SheetHeader>
              ...
              {!pendingType ? (
                    ...
                    <button key={type} type="button" onClick={() => setPendingType(type as AccountType)} className="flex items-center gap-4 p-4 rounded-2xl border-2 border-muted hover:border-primary hover:bg-primary/[0.02] transition-all group text-left shadow-sm">
                      ...
                      <div>
                        <h4 className="font-bold text-[14px] text-slate-900 capitalize flex items-center gap-2">
                          Profil <span className="font-aesthetic text-xl text-primary italic lowercase font-normal leading-none">{type}</span>
                        </h4>
                ...
                <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-aesthetic text-2xl text-primary italic lowercase select-none leading-none">{pendingType}</span>
                  </div>
